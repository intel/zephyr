...
#ifdef CONFIG_CODK_FIRMWARE_VERSION
#define VERSION_SECTION_SIZE 32
#define FIRMWARE_FLASH_END 0x40034000
#define VERSION_SECTION_START (FIRMWARE_FLASH_END - VERSION_SECTION_SIZE)

#define DEFINE_CODK_FIRMWARE_VERSION(string) \
	char codk_version[VERSION_SECTION_SIZE] \
	__attribute__((section("version"))) \
	__attribute__((__used__)) = string
#endif /* CONFIG_CODK_FIRMWARE_VERSION */
